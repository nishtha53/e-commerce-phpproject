        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p>Medico Shop is a brainchild of our Founder who aims to provide its customers an easy access to all healthcare needs beyond physical boundaries in the comfort of their homes.</p>
                </div>
                <div class="col">
                    <img src="./images/about-medicine.png" alt="medicine" id="image">
                </div>
            </div>
    </section>
    <br><br><br><br>
            ...
            <div class="row">
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 22rem;">
                        <img class="card-img-top" src="./images/HJ.jpg" alt="Card image cap">
                        <div class="card-body">
                            <p class="card-text">As the information age unfolds and a borderless world emerges we have a quest to become the most admired group. By encouraging innovation and nurturing intellectual capital, we seek quantum growth to lead in the domestic market. We aim to continually enhance value for our customers with quality products and services to meet their ever changing needs.</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 22rem;">
                        <img class="card-img-top" src="./images/promise.jpg" alt="Card image cap">
                        <div class="card-body">
                            <p class="card-text">Keeping in mind our responsibility towards humanity, we promise:To deliver 100% genuine and quality productsTo deliver the products at the earliest for the benefit of our customers To follow all the guidelines and norms which have been laid down.To serve you to the best of our ability today, tomorrow and always.To serve you the best with affordability.</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="card" style="width: 22rem;">
                        ...
                        <div class="card-body">
                            <p class="card-text">Medico aims to help you manage your day to day requirement with:
                            <ul>
                                <li>Ease</li>
                                <li>Trust</li>
                                <li>Comfort</li>
